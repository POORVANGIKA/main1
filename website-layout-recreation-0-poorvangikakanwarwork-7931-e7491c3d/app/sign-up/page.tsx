    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          {/* Badge */}
          <div className="inline-block px-4 py-2 rounded-full border mb-8" style={{ borderColor: '#14B8A6' }}>
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md">
          {/* Welcome Section */}
          <div className="mb-12">
            <h3 className="text-3xl font-bold mb-3 text-white">Join Luma Vision</h3>
            <p style={{ color: '#CBD5E1' }}>
              Create an account to save your analysis, track progress, and get AI-powered insights.
            </p>
          </div>
          ...
          >
            <h4 className="font-semibold mb-2 text-white">Try it out first</h4>
            <p className="text-sm mb-4" style={{ color: '#CBD5E1' }}>
              Explore features without an account. Sign up anytime to save your work.
            </p>
            <Link
              href="/"
          ...
          <div className="text-center mt-8 text-sm" style={{ color: '#CBD5E1' }}>
            ...
            <Link href="/sign-in" className="font-semibold hover:opacity-80" style={{ color: '#14B8A6' }}>
              Sign in here
            </Link>
          </div>
        </div>
